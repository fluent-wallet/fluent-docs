...
The [Fluent Ethereum provider API](../reference/provider-api.md) is very simple, and wraps
[Conflux eSpace JSON-RPC](https://developer.confluxnetwork.org/conflux-doc/docs/EVM-Space/evm_space_rpc_compatibility) formatted messages, which is why
